/*
* This utils.js file is cloned from strapi's official Amazon AWS S3 Plugin:
* https://github.com/strapi/strapi/blob/main/packages/providers/upload-aws-s3/src/utils.ts 
*/
